...
// Now all axios calls are monitored!`}
            ...
            <Button variant="ghost" size="sm" className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 bg-zinc-800 text-zinc-300" onClick={() => copyCode(`npm i poly-sdk axios`)}>
