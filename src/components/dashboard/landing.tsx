            ...
            <motion.div initial="hidden" animate="visible" variants={stagger} className="flex flex-col items-center">
              ...
              <motion.div variants={fadeUp} custom={3} className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
                <Button size="lg" onClick={onEnterDashboard}
                  className="bg-transparent p-0 hover:bg-transparent p-0/90 text-primary font-semibold text-base rounded-xl px-8 h-12 shadow-lg shadow-gray-200 hover:shadow-gray-300 transition-all hover:scale-[1.02]">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-3 mb-6 sm:mb-8">
              <Button onClick={startSim} disabled={isPlaying} size="lg"
                className="bg-transparent p-0 hover:bg-transparent p-0/90 text-primary rounded-xl h-11 px-6 shadow-lg shadow-gray-200 disabled:opacity-50">
        ...
        <section className="px-4 sm:px-6 pb-20 sm:pb-28">
          <ScrollReveal className="max-w-2xl mx-auto">
            <div className="rounded-2xl border border-border bg-gradient-to-b from-gray-50 to-white p-8 sm:p-10 text-center shadow-sm">
              ...
              <Button size="lg" onClick={onEnterDashboard}
                className="bg-transparent p-0 hover:bg-transparent p-0/90 text-primary font-semibold rounded-xl px-8 h-12 shadow-lg shadow-gray-200">
          ...
          <ScrollReveal className="max-w-3xl mx-auto text-center">
            <div className="rounded-3xl border border-border bg-gradient-to-b from-gray-50 to-white p-8 sm:p-14 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button size="lg" onClick={onEnterDashboard}
                  className="bg-transparent p-0 hover:bg-transparent p-0/90 text-primary font-semibold text-base rounded-xl px-8 h-12 shadow-lg shadow-gray-200">
                  Open Dashboard <ArrowRight className="h-4 w-4 ml-2" />
                </Button>
