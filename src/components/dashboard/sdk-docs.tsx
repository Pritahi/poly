        ...
        <CardContent>
          <Tabs defaultValue="npm" className="w-full">
            ...
            <TabsContent value="npm">
              <CodeBlock language="bash" code={`npm i github:Pritahi/poly-sdk`} />
            </TabsContent>
            <TabsContent value="yarn">
              <CodeBlock language="bash" code={`yarn add github:Pritahi/poly-sdk`} />
            </TabsContent>
            <TabsContent value="pnpm">
              <CodeBlock language="bash" code={`pnpm add github:Pritahi/poly-sdk`} />
            </TabsContent>
          </Tabs>
          <div className="mt-4">
